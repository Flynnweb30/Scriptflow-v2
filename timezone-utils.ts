...
export const TimezoneUtils = {
    ...
    isCallbackDue: function(appointment?: Partial<Appointment> | null): boolean {
        if (!appointment || !appointment.callbackSetting || appointment.callbackSetting === 'none' || appointment.callbackTriggered || appointment.callbackPaused || appointment.callbackCompleted) return false;
